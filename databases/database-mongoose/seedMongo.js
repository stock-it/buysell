...
const Stocks = require('./SchemaMongoose')
...
mongoose.connect('mongodb://localhost/stock2', { useNewUrlParser: true });
...
const stream = fs.createReadStream('./mongooseSeedTest.csv');
